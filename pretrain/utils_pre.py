...
def data_loader(batch_size, imgs, smile_name):
    smiles = load_tensor(smile_name, torch.LongTensor)

    dataset = Dataset(imgs, smiles)
    dataset_loader = torch.utils.data.DataLoader(dataset, batch_size=batch_size, shuffle=True,num_workers=8)#
